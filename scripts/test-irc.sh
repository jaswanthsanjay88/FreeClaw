...
CONTAINER_NAME="freeclaw-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.freeclaw/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run freeclaw:"
echo "  cd packages/freeclaw && go run ./cmd/freeclaw gateway"
echo ""
...
echo "  Join #test, then: freebot: hello"
echo ""
