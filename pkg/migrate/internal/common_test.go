...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.freeclaw")
	assert.Equal(t, "/home/user/.freeclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.freeclaw/workspace/file.txt", "/home/user/.freeclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".freeclaw"), result)
}
