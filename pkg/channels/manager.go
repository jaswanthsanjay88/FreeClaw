...
import (
	...
	"github.com/sipeed/freeclaw/pkg/constants"
...
func (m *Manager) initChannels() error {
	...
	if m.config.Channels.WAReplyMate.Enabled {
		wmCfg := m.config.Channels.WAReplyMate
		if wmCfg.APIBaseURL != "" && wmCfg.MessagesDBPath != "" {
			m.initChannel("wareplymate", "WAReplyMate")
		}
	}
