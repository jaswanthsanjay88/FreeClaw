...
> **影响范围**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/freeclaw/internal/gateway/`
...
import (
    "github.com/sipeed/freeclaw/pkg/bus"
    "github.com/sipeed/freeclaw/pkg/channels"     // 引用父包
    "github.com/sipeed/freeclaw/pkg/config"
    "github.com/sipeed/freeclaw/pkg/identity"      // 新增
    "github.com/sipeed/freeclaw/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/sipeed/freeclaw/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/sipeed/freeclaw/pkg/channels/discord"
    _ "github.com/sipeed/freeclaw/pkg/channels/your_new_channel"  // 新增
)
```
...
4. **Pico Protocol**：`pkg/channels/free/` 实现了一个自定义的 PicoClaw 原生协议 channel，通过 WebSocket webhook (`/free/ws`) 接收消息。
