...
> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/freeclaw/internal/gateway/`
...
│   ├── init.go
│   └── discord.go
├── slack/ line/ onebot/ dingtalk/ feishu/ wecom/ qq/ whatsapp/ whatsapp_native/ maixcam/ free/
│   └── ...
...
import (
    "github.com/sipeed/freeclaw/pkg/bus"
    "github.com/sipeed/freeclaw/pkg/channels"     // Reference parent package
    "github.com/sipeed/freeclaw/pkg/config"
    "github.com/sipeed/freeclaw/pkg/identity"      // New
    "github.com/sipeed/freeclaw/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/freeclaw/internal/gateway/helpers.go
import (
    _ "github.com/sipeed/freeclaw/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/sipeed/freeclaw/pkg/channels/discord"
    _ "github.com/sipeed/freeclaw/pkg/channels/your_new_channel"  // New addition
)
```
...
| `pkg/channels/free/` | `"free"` | TypingCapable, PlaceholderCapable, MessageEditor, WebhookHandler |
...
4. **Pico Protocol**: `pkg/channels/free/` implements a custom PicoClaw native protocol channel that receives messages via WebSocket webhook (`/free/ws`).
