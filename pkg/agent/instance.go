...
import (
	...
	"github.com/sipeed/freeclaw/pkg/routing"
	"github.com/sipeed/freeclaw/pkg/session"
...
func NewAgentInstance(
	...
	contextBuilder := NewContextBuilder(workspace, cfg.GetAssistantName())
...
func resolveAgentWorkspace(agentCfg *config.AgentConfig, defaults *config.AgentDefaults) string {
	...
	// Use the configured default workspace (respects FREECLAW_HOME)
