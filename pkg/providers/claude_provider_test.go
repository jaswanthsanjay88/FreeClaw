...
import (
	...
	anthrofreeption "github.com/anthropics/anthropic-sdk-go/option"

	anthropicprovider "github.com/sipeed/freeclaw/pkg/providers/anthropic"
)
...
func createAnthropicTestClient(baseURL, token string) *anthropic.Client {
	c := anthropic.NewClient(
		anthrofreeption.WithAuthToken(token),
		anthrofreeption.WithBaseURL(baseURL),
	)
	return &c
}
