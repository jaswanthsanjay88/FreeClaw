...
func TestGetConfigPath(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join("/tmp/home", ".freeclaw", "config.json")

	assert.Equal(t, want, got)
}

func TestGetConfigPath_WithFREECLAW_HOME(t *testing.T) {
	t.Setenv("FREECLAW_HOME", "/custom/freeclaw")
	t.Setenv("HOME", "/tmp/home")

	got := GetConfigPath()
	want := filepath.Join("/custom/freeclaw", "config.json")

	assert.Equal(t, want, got)
}

func TestGetConfigPath_WithFREECLAW_CONFIG(t *testing.T) {
	t.Setenv("FREECLAW_CONFIG", "/custom/config.json")
	t.Setenv("FREECLAW_HOME", "/custom/freeclaw")
	t.Setenv("HOME", "/tmp/home")
...
func TestGetConfigPath_Windows(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join(testUserProfilePath, ".freeclaw", "config.json")
...
func TestGetConfigPath_WithEnv(t *testing.T) {
	t.Setenv("FREECLAW_CONFIG", "/tmp/custom/config.json")
