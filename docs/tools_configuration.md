...
All configuration options can be overridden via environment variables with the format `FREECLAW_TOOLS_<SECTION>_<KEY>`:

For example:

- `FREECLAW_TOOLS_WEB_BRAVE_ENABLED=true`
- `FREECLAW_TOOLS_EXEC_ENABLE_DENY_PATTERNS=false`
- `FREECLAW_TOOLS_CRON_EXEC_TIMEOUT_MINUTES=10`
- `FREECLAW_TOOLS_MCP_ENABLED=true`
